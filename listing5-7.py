import pgzrun, time, random, math, pgzero, pygame
import sys
...
objects = {
    ...
    13: [images.electrical1, iamges.half_shadow, " Electrical systems used for powering the space station"],
    ...
    18: [images.pipes2, images.pipes2_shadow, "Pipes for life support systems"],
    19: [images.pipes3, images.pipes3_shadow, "Pipes for life support systems"],
    ...
    31: [imagesfence, None, "A fine gauze fence. It helps protect the station from dust storms".],
    32: [images.contraption, images.contraption_shadows, "One of the scientific experiments. It gently vibrates"],
    ...
    67: [images.foor_pouch, None, "A dehydrated food pouch. It needs water.", "a dry food pack"],
    68: [images.food, None, "A food pouch. Use it get 100% energy.", "ready-to-eat food"],
    ...
    76: [images.scissors, None, "Scissors. They're to blunt to cut anything. Can you sharpen them?", "blunt scissors"],
